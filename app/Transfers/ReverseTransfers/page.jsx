...
export default function ReverseTransfers() {
  ...
  const handleReverseTransfer = async (transferId) => {
    setReversingTransfer(transferId);
    setErrorMessage("");
    setSuccessMessage("");
    try {
      const request = await fetch(
  ...
  const handleReverseAllTransfers = async (e) => {
    e.preventDefault();
    setErrorMessage("");
    setSuccessMessage("");
    try {
      ...
      const request = await fetch(
        `${baseUrl}/api/v1/transfers/reverse-all?transferDate=${encodeURIComponent(transferDate)}`,
        {
          method: "PUT",
          credentials: "include"
        }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 p-4 md:p-6">
      <div className="max-w-7xl mx-auto animate-fadeIn">
        {/* Header Card */}
        <div className="bg-gradient-to-r from-purple-600 via-purple-700 to-red-700 rounded-t-xl shadow-lg p-6 mb-0">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-purple-100 text-sm mt-1">
                  Rollback transfers for specific dates
                </p>
              </div>
            </div>
            {transferDataTable && (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2">
              <h2 className="text-lg font-semibold text-gray-800 mb-4">
                Search Transfers for Reversal
              </h2>
              <p className="text-gray-600 mb-6">
                Select a date to view all transfers that can be reversed. This action should only be used when absolutely necessary.
              </p>

              <form onSubmit={viewTransferData} className="space-y-4">
                  ...
                  <div className="flex items-end space-x-3">
                    <button
                      ...
                      className="px-6 py-3 text-sm font-medium text-white bg-gradient-to-r from-blue-600 to-blue-700 
                                                     ...
                                                     disabled:opacity-70 disabled:cursor-not-allowed disabled:transform-none flex-1"
                    >
                      {viewSpinner ? (
                        <>
                          <Spinner size={20} />
            ...
            <div className="bg-gradient-to-br from-red-50 to-purple-50 border border-red-200 rounded-lg p-6">
              <div className="flex items-start space-x-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-red-700">
                    Reversing transfers is a critical operation. Ensure proper authorization and double-check all details before proceeding.
                  </p>
                </div>
              </div>

              <button
                onClick={handleReverseAllTransfers}
                disabled={reverseSpinner || !transferDataTable || transferData.length === 0}
                className="w-full px-4 py-3 text-sm font-medium text-white bg-gradient-to-r from-red-600 to-red-700 
              ...
              >
                {reverseSpinner ? (
                  ...
                  <>
                    ...
                    <span>Reverse All Transfers</span>
                  </>
                )}
              </button>
            </div>
        ...
        {transferDataTable && (
          <div className="mt-8 animate-fadeIn">
            {/* Table Header */}
            <div className="bg-gradient-to-r from-purple-50 to-red-50 border border-gray-200 rounded-t-xl p-5">
            ...
            <div className="bg-white border border-gray-200 rounded-b-xl shadow-lg overflow-hidden">
                      ...
                      >
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="flex items-center justify-center">
                            <button
                              onClick={() => handleReverseTransfer(element.transferId)}
                              disabled={reversingTransfer === element.transferId}
                              className="px-4 py-2 text-sm font-medium text-white bg-gradient-to-r from-purple-600 to-purple-700 
                            ...
                            >
                              {reversingTransfer === element.transferId ? (
                                <>
                                  <Spinner size={16} />
                                  <span>Reversing...</span>
                                </>
              ...
              <div className="bg-gray-50 px-6 py-4 border-t border-gray-200">
                <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                  <div className="text-sm text-gray-600">
                    <span className="font-semibold">{totalTransfers} transfers</span> pending reversal for {formatDateString(transferDate)}
                  </div>
                  <div className="flex items-center space-x-4">
                    ...
                    <button
                      onClick={handleReverseAllTransfers}
                      disabled={reverseSpinner || transferData.length === 0}
                      className="px-4 py-2 text-sm font-medium text-white bg-gradient-to-r from-red-600 to-red-700 
                                                     rounded-lg hover:from-red-700 hover:to-red-800 focus:ring-4 focus:ring-red-300 
                                                     focus:outline-none transition-all duration-200 flex items-center gap-2
          ...
          <div className="mt-8 bg-white border border-gray-200 rounded-xl shadow-lg p-8 text-center">
            <div className="max-w-md mx-auto">
              ...
              <p className="text-gray-600 mb-4">
                Choose a date above to view transfers that may require reversal.
              </p>
