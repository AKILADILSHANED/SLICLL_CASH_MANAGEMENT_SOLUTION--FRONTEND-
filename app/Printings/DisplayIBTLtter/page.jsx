                    ...
                    <div className="printable-area  text-[12pt] leading-relaxed text-black">
                        ...
                        <section className='mt-8 font-bold'>
                            <p className='underline decoration-1 underline-offset-4'>
                                ...
                                {" "} from {letterData.fromBank}, {letterData.fromBranch}, A/C No. {letterData.fromAccount} to {letterData.toBank}, {letterData.toBranch}, A/C No. {letterData.toAccount} of Sri Lanka Insurance Corporation Life Limited.
                            </p>
                        </section>
...
export default function Page() {
    return (
        <Suspense fallback={<div>Letter is being generated...</div>}>
            <LetterContent />
        </Suspense>
    )
}