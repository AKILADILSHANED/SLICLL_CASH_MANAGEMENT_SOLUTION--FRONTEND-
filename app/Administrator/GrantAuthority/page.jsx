...
export default function GrantAuthority({ onCancel }) {
    ...
    const functionGranting = async (userId, functionId, functionName) => {
        if (!window.confirm(`Are you sure you want to grant the function "${functionName}" to this user?\n\nThis will give the user access to this functionality.`)) {
            return;
        }

        try {
            setGrantingId(functionId);
                        ...
                        <div className="flex items-center space-x-3 mb-4 md:mb-0">
                            ...
                            <div>
                                ...
                                <p className="text-blue-100 text-sm mt-1">
                                    Grant system access permissions to users
                                </p>
                            </div>
                        </div>
                        <button
                            ...
                            <div className="flex flex-col md:flex-row md:items-center justify-between mb-6">
                                <div>
                                    ...
                                    <p className="text-sm text-gray-600 mt-1">
                                        Select functions to grant to the user
                                    </p>
                                </div>
                                <div className="text-sm text-gray-600 mt-2 md:mt-0">
                                    <span className="font-semibold">{availableFunctionList.length}</span> functions available
                                </div>
                            </div>
                                        ...
                                        <tbody className="divide-y divide-gray-200">
                                            {availableFunctionList.map((element, index) => (
                                                ...
                                                >
                                                    ...
                                                    <td className="px-6 py-4 whitespace-nowrap">
                                                        <button
                                                            onClick={() => functionGranting(selectedUser, element.functionId, element.functionName)}
                                                            disabled={grantSpinner && grantingId === element.functionId}
                                                        ...
                                                        >
                                                            {grantSpinner && grantingId === element.functionId ? (
                                                                <>
                                                                    <Spinner size={16} />
                                                                    <span>Granting...</span>
                                                                </>
                        ...
                        <div className="mt-8 bg-gradient-to-r from-green-50 to-blue-50 border border-green-200 rounded-xl shadow-lg p-8 text-center animate-fadeIn">
                            <div className="max-w-md mx-auto">
                                ...
                                <p className="text-gray-600 mb-4">
                                    All functions for the selected user and module have already been granted.
                                </p>
                                <p className="text-sm text-gray-500">
                                    Try selecting a different user or module to see available functions.
                                </p>
                            </div>
                        </div>
                    )}
                    ...
                    {!functionTable && (
                        <div className="mt-8 bg-white border border-gray-200 rounded-xl shadow-lg p-8 text-center">
                            <div className="max-w-md mx-auto">
                                ...
                                <p className="text-gray-600 mb-4">
                                    Select a user and module above to view available functions for granting.
                                </p>
                                <p className="text-sm text-gray-500">
                                    Granting authority gives users access to specific system functions within selected modules.
                                </p>
                            </div>
                        </div>
                    )}
