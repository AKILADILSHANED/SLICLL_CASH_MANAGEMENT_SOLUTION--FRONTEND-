  ...
  const loadRequestData = async () => {
    ...
    try {
      ...
      if (request.status === 200) {
        ...
        setTotalPending(requests.length);
      ...
      <div className="max-w-7xl mx-auto animate-fadeIn">
        ...
        <div className="bg-white rounded-xl shadow-xl border border-gray-200 p-6 md:p-8 -mt-2 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-gradient-to-r from-blue-50 to-blue-100 p-6 rounded-lg border border-blue-200">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-blue-800 mb-1">Pending Requests</p>
            ...
            <div className="bg-gradient-to-r from-green-50 to-green-100 p-6 rounded-lg border border-green-200">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-green-800 mb-1">Total Amount</p>
                  <p className="text-3xl font-bold text-green-900">Rs.{formatCurrency(totalAmount)}</p>
                </div>
            ...
            <div className="bg-gradient-to-r from-yellow-50 to-yellow-100 p-6 rounded-lg border border-yellow-200">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-yellow-800 mb-1">Actions Required</p>
        ...
        <div className="mt-8 animate-fadeIn">
          {requestDetails.length > 0 ? (
            <>
              {/* Table Header */}
              <div className="bg-gradient-to-r from-gray-50 to-green-50 border border-gray-200 rounded-t-xl p-5">
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        {totalPending} requests requiring approval
                      </p>
                    </div>
                  </div>
                  <div className="text-sm text-gray-600">
                    <span className="font-semibold">Total:</span> Rs.{formatCurrency(totalAmount)}
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white border border-gray-200 rounded-b-xl shadow-lg overflow-hidden">
                ...
                <div className="bg-gray-50 px-6 py-4 border-t border-gray-200">
                  <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                    <div className="text-sm text-gray-600">
                      Showing <span className="font-semibold">{totalPending}</span> pending requests
                    </div>
                    <div className="text-sm text-gray-600">
            ...
            <div className="bg-white border border-gray-200 rounded-xl shadow-lg p-8 text-center">
              <div className="max-w-md mx-auto">
                ...
                <p className="text-gray-600 mb-4">
                  All fund requests have been approved.
                </p>
                <p className="text-sm text-gray-500">
                  New pending requests will appear here automatically.
                </p>
                <button
                  onClick={refreshData}
